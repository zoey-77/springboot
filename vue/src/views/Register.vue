<template>
  <div class="wrapper">
    ...
    <div style="margin: 150px auto; background-color: rgba(0,0,0,0.2); width: 350px; height: 340px; padding: 20px; border-radius: 10px">
      <div style="margin: 20px 0; text-align: center; font-size: 24px;color: #fff"><b>注 册</b></div>
