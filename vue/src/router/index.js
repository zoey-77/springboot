  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'Cat',
        name: 'Cat',
        component: () => import('../views/front/Cat.vue')
      },
      {
        path: 'catDetail',
        name: 'CatDetail',
        component: () => import('../views/front/CatDetail.vue')
      },
      {
        path: 'map',
        name: 'Map',
      ...
      },
      {
        path: 'adoptDetail',
        name: 'AdoptDetail',
        component: () => import('../views/front/AdoptDetail.vue')
      },
      {
        path: 'blog',
        name: 'Blog',
      ...
      {
        path: 'myActivityApply',
        name: 'MyActivityApply',
        component: () => import('../views/front/MyActivityApply.vue')
      },
      {
        path: 'myAdoptApply',
        name: 'MyAdoptApply',
        component: () => import('../views/front/MyAdoptApply.vue')
      },
      {
        path: 'myBlog',
        name: 'MyBlog',
        component: () => import('../views/front/MyBlog.vue')
      },
      {
        path: 'message',
        name: 'Message',
