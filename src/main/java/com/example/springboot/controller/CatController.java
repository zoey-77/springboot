...
public class CatController {
    ...
    public Result save(@RequestBody Cat cat) {
        if (cat.getId() == null) {
            //cat.setTime(DateUtil.now());
            //cat.setUser(TokenUtils.getCurrentUser().getNickname());
            //cat.setUserid(TokenUtils.getCurrentUser().getId());
        }
...
//        }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Cat信息表", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Cat> list = reader.readAll(Cat.class);

        catService.saveBatch(list);
        return Result.success();
    }
