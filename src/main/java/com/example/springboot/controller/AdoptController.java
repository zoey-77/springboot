...
public class AdoptController {
    ...
    public Result save(@RequestBody Adopt adopt) {
        if (adopt.getId() == null) {
            ...
            //adopt.setUser(TokenUtils.getCurrentUser().getNickname());
            //adopt.setUserid(TokenUtils.getCurrentUser().getId());
        }
...
//        }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Adopt信息表", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Adopt> list = reader.readAll(Adopt.class);

        adoptService.saveBatch(list);
        return Result.success();
    }
